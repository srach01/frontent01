    ...
    <div className="container mt-5">
      ...
      <div className="row">
        <div className="col-md-4 mb-4">
          <div className="card">
            <img src="/card1.png" className="card-img-top" alt="Card 1" />
        ...
        <div className="col-md-4 mb-4">
          <div className="card">
            <img src="/card2.jpg" className="card-img-top" alt="Card 2" />
            <div className="card-body">
        ...
        <div className="col-md-4 mb-4">
          <div className="card">
            <img src="/card3.jpg" className="card-img-top" alt="Card 3" />
            <div className="card-body">
